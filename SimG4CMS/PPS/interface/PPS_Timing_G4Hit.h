...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef PPS_PPS_Timing_G4Hit_h
#define PPS_PPS_Timing_G4Hit_h 1
...
class PPS_Timing_G4Hit : public G4VHit {
  
public:
  PPS_Timing_G4Hit();
  ~PPS_Timing_G4Hit();
  PPS_Timing_G4Hit(const PPS_Timing_G4Hit &right);
  const PPS_Timing_G4Hit& operator=(const PPS_Timing_G4Hit &right);
  int operator==(const PPS_Timing_G4Hit &){return 0;}
